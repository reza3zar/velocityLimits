...
var nodeInquiry = require("../../../graph_node/transaction/inquiry/inquiryCustomerTransaction");
var nodeManagement = require("../../../graph_node/transaction/nodeHandler/TransactionNodeHandler");
...
var CustomerTransactionHandler = /** @class */ (function () {
    ...
    CustomerTransactionHandler.createCustomerTransactionTree = function (transactionRequest) {
        ...
        transactionRequest.forEach(function (transactionRequest) {
            ...
            else if (!transactin_nodevalidator_1.TransactinNodeValidator.checkCustomerTransactionHasThisYear(nodeInquiry.InquiryCustomerTransaction.getCustomerYearlyTransacion(updateCustomerTransaction, dateTimeParts.year), transactionRequest.customer_id, dateTimeParts, updateCustomerTransaction))
            ...
            else if (!transactin_nodevalidator_1.TransactinNodeValidator.checkCustomerTransactionHasThisWeek(nodeInquiry.InquiryCustomerTransaction.getMonthOfCustomerTransaction(updateCustomerTransaction, dateTimeParts), dateTimeParts, updateCustomerTransaction))
            ...
            else if (!transactin_nodevalidator_1.TransactinNodeValidator.checkCustomerTransactionHasThisDay(nodeInquiry.InquiryCustomerTransaction.getWeekOfCustomerTransaction(updateCustomerTransaction, dateTimeParts), dateTimeParts, updateCustomerTransaction))
